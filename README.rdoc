...
Prior to authentication system, already present in the app:
- Chef model and validations
- Chefs table with columns chefname and email

What needs to be accomplished through building chef authentication system:
...
- Restric actions like create recipe, edit recipe and like feature to loggied in chefs only
